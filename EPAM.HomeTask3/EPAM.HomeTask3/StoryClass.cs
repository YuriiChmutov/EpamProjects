...
namespace EPAM.HomeTask3
{
    ...
    delegate void beginingForEachAnimalDelegate(ref string story, Animal animal);
    delegate void whenTeremokIsEmptyDelegate(ref string story, int answer, List<Animal> teremok, Animal animal);
    delegate void whenTeremokIsNotEmptyDelegate(string listOfAnimals, ref string story, int answer, List<Animal> teremok, Animal animal, Animal animal2);
    ...
    class StoryClass //рабочий класс, в который закинут весь функционал
    {
        ...
        public event beginingForEachAnimalDelegate onBegining;
        public event whenTeremokIsNotEmptyDelegate onWhenTeremokIsNotEmpty;
        public event whenTeremokIsEmptyDelegate onWhenTeremokIsEmpty;
        ...
        public void beginingForEachAnimalMethod(ref string story, Animal animal)
        {
        ...
        public void TeremokIsNotEmptyMethod(string listOfAnimals, ref string story, int answer, List<Animal> teremok, Animal animal, Animal animal2)
        {
            listOfAnimals = "";
            story += $"- Я, ";
        ...
        public void TeremokIsEmptyMethod(ref string story, int answer, List<Animal> teremok, Animal animal)
        {
